...
export const tabVariants = cva(
	[
		...
		"outline-none focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-border-strong focus-visible:ring-offset-1 focus-visible:ring-offset-bg-surface",
